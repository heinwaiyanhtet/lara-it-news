                    ...
                    <div class="border bg-white rounded-lg shadow-sm">
                        <div class="p-4">
                            ...
                            <form action="{{route('register')}}" method="post">
                                ...
                                <input id="name" type="text" class="form-control mb-3 form-control-lg @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
