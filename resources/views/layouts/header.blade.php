        ...
        <div class="p-2 bg-primary d-flex justify-content-between align-items-center rounded">
            ...
            <div class="dropdown">
                <button class="btn btn-light" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{isset(auth()->user()->photo) ? asset('storage/profile/'.auth()->user()->photo) : asset('dashboard/img/user/user-default-photo.jpg') }}" class="user-img shadow-sm" alt="">
                    <span class="ml-0 ml-md-2 d-none d-md-inline-block">{{auth()->user()->name}}</span>
                </button>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{route('profile')}}">Profile</a>
                    <a class="dropdown-item" href="{{route('profile.edit.name.email')}}">Change Password</a>
